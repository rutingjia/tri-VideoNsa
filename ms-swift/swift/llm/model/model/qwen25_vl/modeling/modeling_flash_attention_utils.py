...
if is_torch_npu_available():
    from .npu_flash_attention import index_first_axis, pad_input, unpad_input
    from .npu_flash_attention import npu_apply_rotary_emb as apply_rotary_emb  # noqa
    from .npu_flash_attention import npu_flash_attn_func as flash_attn_func
    from .npu_flash_attention import npu_flash_attn_varlen_func as flash_attn_varlen_func
